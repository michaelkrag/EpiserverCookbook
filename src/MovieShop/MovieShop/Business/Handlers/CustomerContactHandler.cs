...
{
    public class CustomerContactHandler : IRequestHandler<CreateOrUpdateCustomerRequest, CreateOrUpdateCustomerResponce>, IRequestHandler<SetAddressRequest, SetAddressResponce>
    {
